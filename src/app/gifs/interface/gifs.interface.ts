// To parse this data:
//
//   import { Convert, GIFSApp } from "./file";
//
//   const gIFSApp = Convert.toGIFSApp(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GIFSApp {
    data:       Gif[];
...
export class Convert {
    public static toGIFSApp(json: string): GIFSApp {
        return cast(JSON.parse(json), r("GIFSApp"));
    }

    public static gIFSAppToJson(value: GIFSApp): string {
        return JSON.stringify(uncast(value, r("GIFSApp")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Datum": o([
        ...
        { json: "trending_datetime", js: "trending_datetime", typ: Date },
